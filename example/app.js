...
module.exports = function(config, model, callback) {
  var Crypto, FacetForAdmin, FacetForAffiliate, FacetForGuest, FacetForMerchant, FacetForReseller, FacetForRoot, FacetForUser, PermissiveFacet, User, app, encryptPassword, facets, nonce, root, sha1;
  ...
  model.User = {
    ...
    getProfile: function(context, query, next) {
      var _ref;
      User._get(model.UserSelf.schema, context, (_ref = context.user) != null ? _ref.id : void 0, next);
    },
    setProfile: function(context, query, changes, next) {
      var _ref;
